import function_for_all_question
import unittest
...
class check_armstromg_number(unittest.TestCase):
    ...
    def test_armstrong(self):
        result=function_for_all_question.armstrong_number(self.num1)
        self.assertEqual("Armstrong number",result)

    def test_not_armstrong(self):
        result=function_for_all_question.armstrong_number(self.num2)
...
class check_disible_or_not(unittest.TestCase):
    ...
    def test_divisible(self):
        result=function_for_all_question.divisible(self.num1)
        self.assertTrue(result)

    def test_not_divisible(self):
        result=function_for_all_question.divisible(self.num2)
        self.assertTrue(result)
...
class check_largest_of_3num(unittest.TestCase):
    ...
    def test_largest_num(self):
        result=function_for_all_question.Largest_of_3num(self.x,self.y,self.z)
...
class check_even_odd(unittest.TestCase):
    ...
    def test_even(self):
        result=function_for_all_question.even_odd(self.x1)
        self.assertEqual("even",result)

    def test_odd(self):
        result=function_for_all_question.even_odd(self.x2)
